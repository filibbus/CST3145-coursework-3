     ...
     <header>
            ...
            <nav class="navbar navbar-expand-sm navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    ...
                    <h1 style="color: black; margin-right: 600px; font-size: xx-large; font-stretch: ultra-condensed;" class="navbar-brand" v-text="sitename"></h1>
                    <form class="form-inline my-2 my-lg-0">
                        <div class="search-wrapper">
                            <select style="margin-right: 40px;" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" v-model="sort" id="sortby">
